...
- `lua/mojo/lsp.lua` and `lua/mojo/format.lua` are pure option builders (no side effects).
- `lua/mojo/adapters/lspconfig.lua`, `adapters/conform.lua`, `adapters/treesitter.lua` wire the options into their respective generic plugins.
